...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent navigation = new Intent(this, NavigationActivity.class);
        ...
        final TextView text_sign = (TextView) findViewById(R.id.str_registration);
        final Intent intent = new Intent(this, RegistrationActivity.class);
        text_sign.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                text_sign.setTextColor(Color.parseColor("#00007F"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                  user = new Connection().signIn(mLogin,mPassword);
            } catch (Exception exc) {
                exc.printStackTrace();
            }
            return user != null;
